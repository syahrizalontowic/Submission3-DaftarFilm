package com.syahrizal.submission3daftarfilm.ui.home.adapter
...
import com.syahrizal.submission3daftarfilm.databinding.ItemListTvShowBinding
            ...
            with(binding) {
                ...
                Glide.with(itemView.context)
                    .load(
                        "${
                            itemView.context
                                .getString(R.string.poster_base_url)
                        }${tvShow.posterPath}"
                    )
