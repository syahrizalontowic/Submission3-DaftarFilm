...
internal class SortPreference {
    ...
    fun setSortMoviesByTitleAsc(context: Context) {
        preferences = context.getSharedPreferences(
            PREFS_SORT_MOVIES_BY_TITLE_ASC, Context.MODE_PRIVATE
    ...
    fun setSortMoviesByTitleDesc(context: Context) {
        preferences = context.getSharedPreferences(
            PREFS_SORT_MOVIES_BY_TITLE_DESC, Context.MODE_PRIVATE
        ) as SharedPreferences
    ...
    fun setSortTvShowsByNameAsc(context: Context) {
        preferences = context.getSharedPreferences(
            PREFS_SORT_TV_SHOWS_BY_NAME_ASC, Context.MODE_PRIVATE
        ) as SharedPreferences
    ...
    fun setSortTvShowsByNameDesc(context: Context) {
        preferences = context.getSharedPreferences(
            PREFS_SORT_TV_SHOWS_BY_NAME_DESC, Context.MODE_PRIVATE
        ) as SharedPreferences
    ...
    fun setSortTvShowsByNewest(context: Context) {
        preferences = context.getSharedPreferences(
            PREFS_SORT_TV_SHOWS_BY_NEWEST, Context.MODE_PRIVATE
        ) as SharedPreferences
    ...
    fun setSortTvShowsByOldest(context: Context) {
        preferences = context.getSharedPreferences(
            PREFS_SORT_TV_SHOWS_BY_OLDEST, Context.MODE_PRIVATE
        ) as SharedPreferences
